        ...
        <div className="row g-5">
          <div className="col-lg-4 col-md-6">
            ...
            <p className="text-white mb-4" style={{ maxWidth: "300px" }}>
              Your smart companion for comfortable, safe, and flexible stays.
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <ul className="list-unstyled d-flex flex-column gap-2">
              <li>
                <Link to="/terms" className="footer-link text-decoration-none">
                  Terms & Conditions
                </Link>
              </li>
              <li>
            ...
            <ul className="list-unstyled d-flex flex-column gap-3">
              <li className="d-flex gap-3">
                ...
                <span className="text-white">
                  173, M block, Site-1, New Rajinder nagar, Delhi-110060
                </span>
              </li>
              <li className="d-flex gap-3">
                <FaPhoneAlt className="mt-1 text-primary-custom flex-shrink-0" />
                <span className="text-white">
                  {import.meta.env.VITE_COMPANY_MOBILE}
                </span>
              </li>
              <li className="d-flex gap-3">
          ...
          <div className="row align-items-center">
            <div className="col-md-6 text-center text-md-start">
              <small className="text-white">
                &copy; {currentYear} {import.meta.env.VITE_PROJECT_NAME}. All
                rights reserved.
              </small>
            </div>
            <div className="col-md-6 text-center text-md-end mt-3 mt-md-0"></div>
          </div>
        </div>
      </div>
    </footer>
